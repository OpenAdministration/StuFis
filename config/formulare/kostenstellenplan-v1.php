...
$invreftables[] =
  [ "id" => "kosten.invref1",   "name" => "Verwendung",  "type" => "invref",  "width" => 12,
    ...
    "otherForms" => [
      ["type" => "rechnung-zuordnung", "state" => "ok",    "referenceFormField" => "kostenstellenplan.otherForm",
       "addToSum" => [ "ausgaben" => [ "ausgaben.brutto" ] ],
      ],
      ["type" => "rechnung-zuordnung", "state" => "payed", "referenceFormField" => "kostenstellenplan.otherForm",
       "addToSum" => [ "ausgaben" => [ "ausgaben.brutto" ] ],
      ],
      ["type" => "rechnung-zuordnung", "state" => "instructed", "referenceFormField" => "kostenstellenplan.otherForm",
       "addToSum" => [ "ausgaben" => [ "ausgaben.brutto" ] ],
      ],
