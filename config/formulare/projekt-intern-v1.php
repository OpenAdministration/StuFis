...
$layout[] = [
    ...
    "value" => "Internes Projekt erstellen",
];
...
$layout[] = [
    ...
    "children" => [
        ["id" => "genehmigung.recht.grp", "title" => "Rechtsgrundlage", "type" => "group", "width" => 12, "children" => [
            ...
            ["id" => "genehmigung.recht.grp.4b", "type" => "group", "width" => 12,
                "children" => [
...
$layout[] = [
    ...
    "children" => [
        ["id" => "projekt.name", "title" => "Projektname", "type" => "text", "width" => 12, "opts" => ["required", "hasFeedback"], "minLength" => "10", "onlyEditableInStates" => ["createState", "draft"],],
        ["id" => "projekt.leitung", "title" => "Projektverantwortlich (eMail)", "type" => "email", "width" => 12, "placeholder" => "Vorname.Nachname@tu-ilmenau.de", "prefill" => "user:mail", "opts" => ["required", "hasFeedback"], "onlyEditableInStates" => ["createState", "draft"],],
        ["id" => "projekt.org.name", "title" => "Projekt von", "type" => "text", "width" => 6, "data-source" => "own-orgs", "placeholder" => "Institution wählen", "opts" => ["required", "hasFeedback"], "onlyEditableInStates" => ["createState", "draft"],],
        ["id" => "projekt.org.mail", "title" => "Benachrichtigung (Mailingliste zu \"Projekt von\")", "type" => "email", "width" => 6, "data-source" => "own-mailinglists", "placeholder" => "Mailingliste wählen", "opts" => ["required", "hasFeedback"], "onlyEditableInStates" => ["createState", "draft"],],
        ["id" => "projekt.protokoll", "title" => "Projektbeschluss (Wiki Direktlink)", "type" => "url", "width" => 12, "placeholder" => "https://wiki.stura.tu-ilmenau.de/protokoll/...", "opts" => ["not-required", "hasFeedback", "wikiUrl"], "pattern" => "^https:\/\/wiki\.stura\.tu-ilmenau\.de\/protokoll\/.*", "pattern-error" => "Muss mit \"https://wiki.stura.tu-ilmenau.de/protokoll/\" beginnen.", "onlyEditableInStates" => ["createState", "draft"],],
        ["id" => "projekt.zeitraum", "title" => "Projektdauer", "type" => "daterange", "width" => 12, "opts" => ["required"], "onlyEditableInStates" => ["createState", "draft"],],
    ],
];
// only for state draft (simplyfied Version)
$layout[] = [
    "type" => "table", /* renderer */
    "id" => "finanzgruppentbl",
...
$layout[] = [
    ...
    "columns" => [
        [
            ...
            "children" => [
                ["id" => "geld.name", "name" => "Ein/Ausgabengruppe", "type" => "text", "width" => 2, "opts" => ["required", "title"], "onlyEditableInStates" => ["createState", "draft"],
                    "placeholder" => "Name des Postens",
                ],
                ["id" => "geld.bemerkung", "width" => 2, "name" => "Bemerkung", "type" => "text", "placeholder" => "Bemerkung optional", "onlyEditableInStates" => ["createState", "draft"]],
                ["id" => "geld.titel", "name" => "Titel", "type" => "ref", "width" => 2,
                    "placeholder" => "s. Genehmigung",
                    ...
                    "editOnlyInStates" => ["wip",],
                ],
                
                ["id" => "geld.konto", "name" => "Kostenstelle", "type" => "ref", "width" => 2,
                    "placeholder" => "s. Genehmigung",
                ...
                ["id" => "geld.invref.grp", "type" => "group", "width" => 12, "opts" => ["well"],
                    "children" => [
                        ["id" => "geld.invref.0", "name" => "Verwendung", "type" => "invref", "width" => 12, "opts" => ["with-headline", "aggregate-by-otherForm"],
                            ...
                            "otherForms" => [
                                ["type" => "rechnung-zuordnung", "state" => "ok", "referenceFormField" => "teilrechnung.projekt",
                                    "addToSum" => ["ausgaben" => ["ausgaben.erstattet"]],
                                ],
                                ["type" => "rechnung-zuordnung", "state" => "payed", "referenceFormField" => "teilrechnung.projekt",
                                    "addToSum" => ["ausgaben" => ["ausgaben.erstattet"]],
                                ],
                                ["type" => "rechnung-zuordnung", "state" => "instructed", "referenceFormField" => "teilrechnung.projekt",
                                    "addToSum" => ["ausgaben" => ["ausgaben.erstattet"]],
                                ],
                        ...
                        ["id" => "geld.invref.1", "name" => "Verwendung", "type" => "invref", "width" => 12, "opts" => ["with-headline", "aggregate-by-otherForm"],
                            ...
                            "otherForms" => [
                                ["type" => "rechnung-zuordnung", "state" => "draft", "referenceFormField" => "teilrechnung.projekt",
                                    "addToSum" => ["ausgaben" => ["ausgaben.beantragt"]],
                                ],
                                ["type" => "rechnung-zuordnung", "state" => "ok-hv", "referenceFormField" => "teilrechnung.projekt",
                                    "addToSum" => ["ausgaben" => ["ausgaben.beantragt"]],
                                ],
                                ["type" => "rechnung-zuordnung", "state" => "ok-kv", "referenceFormField" => "teilrechnung.projekt",
                                    "addToSum" => ["ausgaben" => ["ausgaben.beantragt"]],
                                ],
                            ...
                            "extraFooter" => [ # hidden if no invref references
                                ["id" => "geld.invref.1.sum", "type" => "group", "width" => 12, "title" => "Nach Abzug der getätigten oder beantragten Auslagenerstattungen verbleiben",
                                    "children" => [
                                        ...
                                        ["id" => "genehmigung.titel", "title" => "Titel im Haushaltsplan", "type" => "ref", "width" => 2, "opts" => ["hasFeedback", "no-invref"], "placeholder" => "optional",
                                            "references" => [["type" => "haushaltsplan", "revision" => date("Y"), "state" => "final"], ["titel.ausgaben" => "Ausgaben", "titel.einnahmen" => "Einnahmen"]],
                                            "referencesKey" => ["titel.einnahmen" => "titel.einnahmen.nummer", "titel.ausgaben" => "titel.ausgaben.nummer"],
                                            "referencesId" => "haushaltsplan.otherForm",
                                        ],
                                        ["id" => "genehmigung.konto", "title" => "Kostenstelle", "type" => "ref", "width" => 2, "opts" => ["hasFeedback", "no-invref"], "placeholder" => "optional",
                                            "references" => [["type" => "kostenstellenplan", "revision" => date("Y"), "state" => "final"], "kosten"],
                                            "referencesKey" => ["kosten" => "kosten.nummer"],
                                            "referencesId" => "kostenstellenplan.otherForm",
                                        ],
...
$layout[] = [
    ...
    "min-rows" => 10,
    "opts" => ["required"],
    "editOnlyInStates" => ["createState", "draft"],
];
