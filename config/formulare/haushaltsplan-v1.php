...
foreach ( ["einnahmen" => "Einnahmen", "ausgaben" => "Ausgaben"] as $id => $caption) {
    ...
    $invreftables[] =
        [ "id" => "titel.$id.invrefzahlungen",   "name" => "Verwendung",  "type" => "invref",  "width" => 12,
         ...
         "otherForms" => [
             ["type" => "rechnung-zuordnung", "state" => "ok", "referenceFormField" => "haushaltsplan.otherForm",
              "addToSum" => [ "expr: %ausgaben" => [ "ausgaben.netto" ] ],
             ],
             ["type" => "rechnung-zuordnung", "state" => "payed", "referenceFormField" => "haushaltsplan.otherForm",
              "addToSum" => [ "expr: %ausgaben" => [ "ausgaben.netto" ] ],
             ],
             ["type" => "rechnung-zuordnung", "state" => "instructed", "referenceFormField" => "haushaltsplan.otherForm",
              "addToSum" => [ "expr: %ausgaben" => [ "ausgaben.netto" ] ],
             ],
             ["type" => "auslagenerstattung", "state" => "ok", "referenceFormField" => "haushaltsplan.otherForm",
              "addToSum" => [ "expr: %einnahmen - %ausgaben" => [ "einnahmen.netto" ],
                             "expr: %ausgaben - %einnahmen" => [ "ausgaben.netto" ] ],
             ],
             ["type" => "auslagenerstattung", "state" => "payed", "referenceFormField" => "haushaltsplan.otherForm",
              "addToSum" => [ "expr: %einnahmen - %ausgaben" => [ "einnahmen.netto" ],
                             "expr: %ausgaben - %einnahmen" => [ "ausgaben.netto" ] ],
             ],
             ["type" => "auslagenerstattung", "state" => "instructed", "referenceFormField" => "haushaltsplan.otherForm",
              "addToSum" => [ "expr: %einnahmen - %ausgaben" => [ "einnahmen.netto" ],
                             "expr: %ausgaben - %einnahmen" => [ "ausgaben.netto" ] ],
             ],
             ["type" => "extern-express", "state" => "instructed", "referenceFormField" => "haushaltsplan.otherForm",
              "addToSum" => ["geld.stura" => [ "ausgaben.netto" ] ],
             ],
         ],
        ];
    $children[] = [
