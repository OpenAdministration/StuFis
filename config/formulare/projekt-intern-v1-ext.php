...
$config = [
  ...
  "revisionTitle" => "Version 20170126 (Erweitert)",
  "permission" => [
    "isCorrectGremium" => [
...
#     [ "id" => "projekt.org.name2",    "title" =>"Projekt von",                        "type" => "select", "width" =>  12, "data-source" => "own-orgs", "placeholder" => "Institution wählen", "opts" => ["required", "hasFeedback"] ],
 ...
 [
   ...
   "columns" => [
     [ "id" => "geld.name",        "name" => "Ein/Ausgabengruppe",                 "type" => "text",   "width" => 2, "opts" => [ "required" ] ],
     ...
     [ "id" => "geld.titel",       "name" => "Titel",                              "type" => "text",   "width" => 2, "placeholder" => "s. Kopfbereich", ],
     [ "id" => "geld.konto",       "name" => "Konto (Gnu-Cash)",                   "type" => "text",   "width" => 2, "placeholder" => "s. Kopfbereich", ],
   ], // finanzgruppentbl
 ],
...
registerForm( "projekt-intern", "v1-ext", $layout, $config );
