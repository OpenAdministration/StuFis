...
for ($year = 2017; $year <= date("Y") + 1; $year++):
    ...
    $children = [
        ...
        ["id" => "titel.$id.name", "name" => "Bezeichnung", "type" => "text", "width" => ($year == date("Y") ? 4 : 6), "editWidth" => 4, "opts" => ["required", "title"]],
        ["id" => "titel.$id.einnahmen", "name" => "Einnahmen", "type" => "money", "width" => 2, "editWidth" => 3, "opts" => ["required", "sum-over-table-bottom"], "currency" => "€", "addToSum" => ["einnahmen"]],
        ["id" => "titel.$id.ausgaben", "name" => "Ausgaben", "type" => "money", "width" => 2, "editWidth" => 3, "opts" => ["required", "sum-over-table-bottom"], "currency" => "€", "addToSum" => ["ausgaben"]],
    ];
    if ($year == date("Y")){
        if ($id == "einnahmen"){
            $children[] =
