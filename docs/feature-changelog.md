...
* Haushaltsplan: Beschluss-, Genehmigungs- und Wirksamkeitsdatum werden nun direkt im Dialog des Statuswechsels erfasst – also in dem Moment, in dem das jeweilige Datum entsteht – statt losgelöst davon im Bearbeiten-Formular. Die Angabe bleibt optional, und die Daten sind in der Plan-Ansicht weiterhin sichtbar.
