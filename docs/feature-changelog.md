...
* Bankimport (FinTS): Beim Anlegen eines Kontos für den Import wird die Eingabe nun geprüft, statt sie ungeprüft zu speichern: Die IBAN muss gültig sein und zu einem Konto des gewählten Bankzugangs gehören, das Kürzel muss aus genau zwei Buchstaben bestehen und darf noch nicht vergeben sein, für dieselbe IBAN kann kein zweites Konto angelegt werden, und das Startdatum muss ein gültiges Datum sein. Zuvor konnte ein Konto mit ungültiger IBAN, doppeltem Kürzel oder fremder IBAN entstehen – mit der Folge, dass Umsätze gar nicht oder im falschen Konto landeten.
* Bankimport (FinTS): Der Aufruf des Umsatzimports für ein noch nicht eingerichtetes Konto führte zu einer Fehlerseite; nun wird auf das Anlegen des Kontos hingewiesen. Ebenso führt ein Konto ohne gesetztes Startdatum nicht mehr zum Abbruch.
