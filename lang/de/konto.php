...
return [
    ...
    "manual-button-reverse-csv-order-sub" => "Einige Banken exportieren Transaktionsdaten chronologisch aufsteigend, andere absteigend. Falls z.B. die Saldo-Validierung fehlschlägt, kannst du diese Option anwenden.",
