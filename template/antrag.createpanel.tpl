...
?>
    ...
    <!-- Modal -->
    <form action="<?php echo $URIBASE; ?>" method="POST" role="form" data-toggle="validator"
          enctype="multipart/form-data" id="newantragform" class="ajax">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="selectpicker form-control" name="type" size="1" data-dep="revisionselect"
                                    title="Bitte Antragstyp auswählen..." required="required" id="newantragtype">
                                <?php
                                foreach ($menu as $m){
                        ...
                        <div class="form-group optional-select">
                            ...
                            <select class="selectpicker form-control" name="revision" size="1"
                                    title="2. Bitte Revision des neuen Antrags auswählen..." id="revisionselect"
