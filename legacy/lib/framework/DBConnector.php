...
class DBConnector extends Singleton
{
    ...
    private function initScheme(): void
    {
        ...
        $scheme['auslagen'] = [
            ...
            'ok_belege' => "VARCHAR(255) NOT NULL DEFAULT ''",
            'ok_hv' => "VARCHAR(255) NOT NULL DEFAULT ''",
            'ok_kv' => "VARCHAR(255) NOT NULL DEFAULT ''",
            'payed' => "VARCHAR(255) NOT NULL DEFAULT ''",
            'rejected' => "VARCHAR(255) NOT NULL DEFAULT ''",
            'zahlung_iban' => 'VARCHAR(1023) NOT NULL',
        ...
        $scheme['extern_data'] = [
            ...
            'ok_hv' => 'varchar(63) NULL',
            'ok_kv' => 'varchar(63) NULL',
            'frist' => 'DATETIME NULL',
