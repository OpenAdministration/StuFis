            ...
            foreach ($group as $titel_id => $row) {
                ...
                $gsum_saved += $row['_saved']; ?>
                    <tr>
                        ...
                        <td <?php echo $this->checkTitelBudget($row['value'], $row['_booked']); ?>>
							<?php echo DBConnector::getInstance()->convertDBValueToUserValue($row['_booked'], 'money'); ?>
                        </td>
                        <td <?php echo $this->checkTitelBudget($row['value'], $row['_saved']); ?>>
                ...
                <tr class="table-sum-footer">
                    ...
                    <td class="money table-sum-hhpgroup">
                        <?php echo DBConnector::getInstance()->convertDBValueToUserValue($gsum_soll, 'money'); ?>
                    </td>
                    <td class="money table-sum-hhpgroup">
                        <?php echo DBConnector::getInstance()->convertDBValueToUserValue($gsum_ist, 'money'); ?>
                    </td>
                    <td class="money table-sum-hhpgroup">
                        <?php echo DBConnector::getInstance()->convertDBValueToUserValue($gsum_saved, 'money'); ?>
                    </td>
                </tr>
                </tbody>
				<?php
